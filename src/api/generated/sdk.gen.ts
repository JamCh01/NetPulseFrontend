...
/**
 * 生成并跳转到 Agent Artifact 的限时签名下载地址，用于下载安装指定版本的 Agent 可执行文件
 */
...
/**
 * 校验限时签名后返回 Agent Artifact 文件内容，下载 URL 的 TTL 由系统设置控制
 */
export const getAgentArtifactFileApiV1ArtifactsAgentsArtifactUuidFileGet = <ThrowOnError extends boolean = false>(options: Options<GetAgentArtifactFileApiV1ArtifactsAgentsArtifactUuidFileGetData, ThrowOnError>) => (options.client ?? client).get<GetAgentArtifactFileApiV1ArtifactsAgentsArtifactUuidFileGetResponses, GetAgentArtifactFileApiV1ArtifactsAgentsArtifactUuidFileGetErrors, ThrowOnError>({ url: '/api/v1/artifacts/agents/{artifact_uuid}/file', ...options });
